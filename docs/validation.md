...
Publication checks: a separate clean clone installed as a non-editable package passed the same 167-test suite and the toy search/local-image packet demo. The initial [GitHub Actions run](https://github.com/Dryxio/gta-asset-search/actions/runs/34073391506) passed on Python 3.10 and 3.12. The staged-file audit allowed only source/docs/tests and four curated PNG renders; no native asset, database, private source path or credential pattern was present.
